...
class Bug(models.Model):
    ...
    bugname = models.CharField('名称',max_length=64)#bug名称
    ...
    buglevel = models.CharField(verbose_name='严重程序',choices=BUG_LEVEL,default='3',max_length=200,null=True)#严重程度
    bugcreater = models.CharField('创建人',max_length=200)#创建人
    bugassign = models.CharField('分配给',max_length=200)#分配给
    create_time = models.DateTimeField('创建时间',auto_now=True)#更新时间值
    class Meta:
        verbose_name = 'bug管理'
